     ...
     {
          param (
                [string]$Title = 'Opciones a ejecutar'
          )
          cls
          Write-Host "================ $Title ================"
            
       Write-Host "1: Presione '1' para Ver-StatusPerfil"
       Write-Host "2: Presione '2' para Cambiar-StatusPerfil"
       Write-Host "3: Presione '3' para Ver-PerfilRedActual"
       Write-Host "4: Presione '4' para Cambiar-PerfilRedActual"
       Write-Host "5: Presione '5' para Ver-ReglasBloqueo"
       Write-Host "6: Presione '6' para Agregar-ReglasBloqueo"
       Write-Host "7: Presione '7' para Eliminar-ReglasBloqueo"
          
       Write-Host "Q: Press 'Q' para salir."
     }
